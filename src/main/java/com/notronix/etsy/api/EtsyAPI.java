...
public interface EtsyAPI
{
    ...
    List<? extends ApiMethod> getMethodTable() throws EtsyAPIException;

    DataType describeOccasionEnum() throws EtsyAPIException;

    DataType describeRecipientEnum() throws EtsyAPIException;

    DataType describeWhenMadeEnum(Boolean includeFormatted) throws EtsyAPIException;

    DataType describeWhoMadeEnum() throws EtsyAPIException;

    List<? extends Country> findAllCountry() throws EtsyAPIException;

    List<? extends Style> findSuggestedStyles() throws EtsyAPIException;
    ...
    String getAvatarImgSrc(Credentials accessCreds, String userId) throws EtsyAPIException;
    ...
    Response<? extends List<? extends Shop>> findAllUserShops(Credentials accessCreds, String userId, Integer limit,
    ...
    List<? extends Taxonomy> getSellerTaxonomy() throws EtsyAPIException;

    List<? extends TaxonomyNodeProperty> getTaxonomyNodeProperties(Long taxonomyId) throws EtsyAPIException;
    ...
    ListingImage uploadListingImage(Credentials accessCreds, Long listingId, File image,
                                    Integer rank, Boolean overwrite, Boolean isWaterMarked) throws EtsyAPIException;
    ...
    Cart getUserCart(Credentials accessCreds, String userId, Long cartId) throws EtsyAPIException;

    Cart addToCart(Credentials accessCreds, String userId, Long listingId, Integer quantity) throws EtsyAPIException;

    List<? extends Coupon> findAllShopCoupons(Credentials accessCreds, String shopIdOrName) throws EtsyAPIException;

    Response<? extends List<? extends Receipt>> findAllShopReceipts(Credentials accessCreds, String shopIdOrName,
