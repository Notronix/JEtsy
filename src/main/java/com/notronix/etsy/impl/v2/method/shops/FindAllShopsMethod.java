...
public class FindAllShopsMethod extends EtsyMethod<EtsyResponse<List<EtsyShop>>>
{
    ...
    @Override
    public EtsyResponse<List<EtsyShop>> getResponse(Unmarshaller unmarshaller, String payload) {
        return unmarshaller.unmarshal(payload, new TypeToken<EtsyResponse<List<EtsyShop>>>(){}.getType());
    }
